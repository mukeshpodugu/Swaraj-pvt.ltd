  ...
  useEffect(() => {
    async function loadDashboard() {
      try {
        ...
        const activeChitsVal = chits.reduce((sum, g) => sum + g.groupValue, 0);
        const licPipelineVal = policies.reduce(
          ...
          l.emiInstallments.forEach((e) => {
            if (
              ...
              defaulterAlerts.push({
                ...
                due: e.totalAmount,
                days: Math.ceil(
                  Math.abs(today.getTime() - new Date(e.dueDate).getTime()) /
                    (1000 * 60 * 60 * 24),
                ),
              });
            }
          ...
          recentActivity: [
            {
              id: 1,
              type: "LOAN",
              desc: "New loan application submitted by Priya Nair",
              date: "Today",
            },
            {
              id: 2,
              type: "PAYMENT",
              desc: "Amit Patel cleared Personal Loan EMI #2 successfully",
              date: "Yesterday",
            },
            {
              id: 3,
              type: "CHIT",
              desc: "Resolved Swaraj Royal 2 Lakhs Chit auction installment #1",
              date: "2 days ago",
            },
          ],
          chartData: [
            ...
            {
              name: "Jun",
              Collections: activeCollections || 105000,
              Disbursements: totalDisbursed || 200000,
            },
          ],
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Monitoring active portfolios for Swaraj Pvt. Limited branch
            operations.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <h3 className="text-2xl font-bold">
                Rs. {metrics.totalDisbursed.toLocaleString()}
              </h3>
            </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5 shadow-sm relative overflow-hidden group">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <h3 className="text-2xl font-bold">
                Rs. {metrics.activeCollections.toLocaleString()}
              </h3>
            </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5 shadow-sm relative overflow-hidden group">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <h3 className="text-2xl font-bold">
                Rs. {metrics.activeChitsVal.toLocaleString()}
              </h3>
            </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5 shadow-sm relative overflow-hidden group">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                LIC Premiums Tracked
              </span>
              <h3 className="text-2xl font-bold">
                Rs. {metrics.licPipelineVal.toLocaleString()}
              </h3>
            </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              <h4 className="font-bold text-base">
                Collections vs. Capital Outflow
              </h4>
              <p className="text-xs text-muted-foreground">
                Historical comparison of customer loan disbursements and monthly
                EMI receipts.
              </p>
            </div>
            <span className="bg-primary/10 text-primary border border-primary/25 px-2 py-0.5 rounded text-[10px] font-semibold">
              6-Month Trend
            </span>
          </div>
          <div className="h-72">
          ...
          <div className="bg-slate-900 border border-slate-800 text-slate-100 rounded-xl p-5 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-xs leading-relaxed text-slate-300">
              <div className="border-l-2 border-primary pl-3 py-0.5">
                ...
                <p>
                  Priya Nair shows a low debt ratio (LTV 42%). Credit model
                  recommends immediate approval of applied home loan.
                </p>
              </div>
              <div className="border-l-2 border-red-500 pl-3 py-0.5">
                <p className="font-semibold text-white text-red-400">
                  Default Risk Warning
                </p>
                <p>
                  Amit Patel personal loan default risk score has increased by
                  15% due to a 5-day delay in current EMI #3.
                </p>
              </div>
            </div>
          </div>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[10px] text-muted-foreground">
                          {policy.planName} &bull; {policy.policyNumber}
                        </span>
                      </div>
                      <div className="text-right">
                        <p className="font-bold">
                          Rs. {policy.premiumAmount.toLocaleString()}
                        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-card border border-border rounded-xl p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-bold text-sm">
                Critical Overdue Payments ({metrics.defaultersCount})
              </h4>
            </div>
          ...
          {metrics.defaulterAlerts.length === 0 ? (
            <p className="text-xs text-muted-foreground">
              No accounts are currently delinquent.
            </p>
          ) : (
            <div className="divide-y divide-border">
              {metrics.defaulterAlerts.map((alert, i) => (
                <div
                  key={i}
                  className="flex justify-between items-center py-3 first:pt-0 last:pb-0 text-xs"
                >
                  <div>
                  ...
                  <div className="text-right">
                    <p className="font-bold text-destructive">
                      Rs. {alert.due.toLocaleString()}
                    </p>
                    <span className="text-[10px] font-semibold text-destructive">
                      {alert.days} Days Past Due
                    </span>
                  </div>
                </div>
              ))}
