  ...
  const handleVerifyKYC = async (status) => {
    ...
    try {
      ...
      const timelineRes = await axios.get(
        `/api/customers/${selectedCust.id}/timeline`,
      );
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Search profiles, trace documentation verification, and check KYC
              status.
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-muted-foreground space-y-2">
            ...
            <p className="text-xs">
              Adjust search parameters or check filters.
            </p>
          </div>
        ) : (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-muted-foreground">
                            {cust.user.email} &bull; {cust.user.phone}
                          </span>
                        </div>
                      </div>
                    </td>
                    <td className="py-4">
                      <p className="font-semibold text-muted-foreground">
                        PAN: <code className="text-foreground">{cust.pan}</code>
                      </p>
                      <span className="text-[10px] text-muted-foreground">
                        Aadhaar: <code>{cust.aadhaar}</code>
                      </span>
                    </td>
        ...
        <div className="xl:col-span-4 bg-card border border-border rounded-2xl p-6 shadow-sm space-y-6 fade-in">
          ...
          <div className="flex items-center gap-4 bg-accent/30 p-4 rounded-xl">
            {selectedCust.photoUrl ? (
              <img
                ...
                alt={selectedCust.user.fullName}
            ...
            <div>
              <h4 className="font-bold text-sm text-foreground">
                {selectedCust.user.fullName}
              </h4>
              <p className="text-[10px] text-muted-foreground">
                {selectedCust.user.email}
              </p>
              <span className="text-[10px] bg-primary/10 text-primary px-2 py-0.5 rounded font-bold uppercase mt-1 inline-block">
                Role: Customer
              </span>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="space-y-2.5">
              <h5 className="font-bold text-[11px] text-muted-foreground uppercase tracking-widest border-l-2 border-primary pl-2">
                Identity Details
              </h5>
              ...
              <div className="grid grid-cols-2 gap-4 bg-accent/20 p-3 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {selectedCust.employerName || "Self Employed / Retd"}
                  </p>
                </div>
                <div className="col-span-2">
                  <span className="text-[10px] text-muted-foreground block">
                  ...
                  <p className="font-extrabold text-foreground text-sm">
                    Rs. {selectedCust.monthlyIncome.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="bg-accent/20 p-3 rounded-lg space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">
                    <code>{selectedCust.nomineePhone}</code>
                  </span>
                </div>
              </div>
            </div>
            ...
            {selectedCust.kycStatus === "PENDING" && (
              <div className="bg-orange-500/5 border border-orange-500/20 p-4 rounded-xl space-y-3">
                ...
                <p className="text-[10px] text-muted-foreground leading-normal">
                  Verify Aadhaar & PAN details match before checking VERIFIED
                  status.
                </p>
                <textarea
            ...
            <div className="space-y-3">
              ...
              {loadingTimeline ? (
                ...
                <p className="text-[10px] text-muted-foreground">
                  No chronological history recorded.
                </p>
              ) : (
