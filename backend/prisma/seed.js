...
async function main() {
  ...
  const settings = await prisma.companySetting.create({
    data: {
      ...
      logoUrl:
        "https://images.unsplash.com/photo-1614028674026-a65e31bfd27c?w=128&h=128&fit=crop",
    ...
    data: [
      {
        ...
        action: "SYSTEM_BOOT",
        details: "Database seeded with core operational metrics.",
      },
      {
        userId: admin.id,
        action: "KYC_RESOLVE",
        details: "Admin Vikram resolved customer Amit Patel KYC.",
      },
    ],
  });
