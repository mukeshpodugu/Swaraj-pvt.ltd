...
export class LICController {
  ...
  static async createPolicy(req, res) {
    ...
    if (
      ...
      return res
        .status(400)
        .json({ error: "Required LIC policy details are missing." });
    }
    ...
    try {
      ...
      return res
        .status(400)
        .json({ error: "Registration failed. Policy number must be unique." });
    }
  }
   ...
   */
  static async payPremium(req, res) {
    ...
    try {
      ...
      try {
        ...
        console.error(
          "Failed to send LIC next due notice on premium payment",
          mailErr,
        );
      }
      ...
      return res.json({
        message:
          "LIC Premium payment registered successfully. Next due date updated.",
        history,
      ...
      return res
        .status(500)
        .json({ error: "Server error registering premium payment." });
    }
  }
   ...
   */
  static async getRenewalAlerts(req, res) {
    try {
      ...
      return res
        .status(500)
        .json({ error: "Server error checking renewal alerts." });
    }
  }
  ...
  static async getPolicies(req, res) {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "Server error retrieving policies." });
    }
  }
}
