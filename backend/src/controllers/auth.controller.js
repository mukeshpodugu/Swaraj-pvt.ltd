...
const REFRESH_SECRET =
  process.env.REFRESH_SECRET || "swaraj-super-refresh-key-67890";
...
export class AuthController {
  ...
  static async register(req, res) {
    ...
    try {
      ...
      let customerProfileId = undefined;
  ...
  static async googleSignIn(req, res) {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "Server error during Google Sign-in." });
    }
  }
  ...
  static async forgotPassword(req, res) {
    ...
    try {
      ...
      return res.json({
        message: "Password recovery email dispatched successfully.",
      });
    } catch (err) {
