...
export class MailService {
   ...
   */
  static getBrandedTemplate(title, bodyContent) {
    return `
      <!DOCTYPE html>
      <html>
      <head>
  ...
  static async sendWelcomeEmail(customerId, email, name) {
    const body = `
    ...
    await this.sendEmail(
      customerId,
      email,
      "Welcome to Swaraj FinancePro AI",
      "Account Activated",
      body,
      "WELCOME",
    );
  ...
  static async sendLoanStatusEmail(
    customerId,
    email,
    name,
    loanType,
  ...
  static async sendOverdueReminderEmail(
    customerId,
    email,
    name,
    productName,
