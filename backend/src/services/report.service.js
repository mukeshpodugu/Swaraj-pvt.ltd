  ...
  static async generatePDF(data) {
    return new Promise((resolve, reject) => {
      try {
        ...
        // --- Brand Header ---
        doc
          .fillColor("#0b192c") // Deep Navy Blue
          .rect(0, 0, 595.28, 90)
          .fill();
        ...
        doc
          ...
          .fontSize(10)
          .fillColor("#ffffff")
          .text("OFFICIAL SYSTEM REPORT", 420, 25, {
            align: "right",
            width: 135,
          });
        doc
          .font("Helvetica")
          .fontSize(8)
          .text(`Date: ${new Date().toLocaleDateString()}`, 420, 40, {
            align: "right",
            width: 135,
          });
        ...
        // Draw Header
        doc
          .fillColor("#1e3a8a") // Royal Blue Header
        ...
        data.headers.forEach((header) => {
          doc.text(header, currentX + 6, startY + 8, {
            width: colWidth - 12,
            ellipsis: true,
          });
          currentX += colWidth;
        ...
        data.rows.forEach((row, index) => {
          ...
          if (currentY > 750) {
            ...
            doc.fillColor("#1e3a8a").rect(40, currentY, tableWidth, 24).fill();
            doc.fillColor("#ffffff").font("Helvetica-Bold").fontSize(9);
            let tempX = 40;
            data.headers.forEach((header) => {
              doc.text(header, tempX + 6, currentY + 8, {
                width: colWidth - 12,
                ellipsis: true,
              });
              tempX += colWidth;
          ...
          if (index % 2 === 1) {
            doc.fillColor("#f9fafb").rect(40, currentY, tableWidth, 20).fill();
          }
          ...
          data.keys.forEach((key) => {
            ...
            if (rawVal instanceof Date) {
              ...
              valStr = rawVal.toLocaleString(undefined, {
            ...
            doc.text(valStr, cellX + 6, currentY + 6, {
              width: colWidth - 12,
              ellipsis: true,
            });
            cellX += colWidth;
        ...
        if (data.totals) {
          doc.fillColor("#f1f5f9").rect(40, currentY, tableWidth, 22).fill();
          ...
          data.keys.forEach((key, index) => {
            ...
            doc.text(text, totalX + 6, currentY + 7, {
              width: colWidth - 12,
              ellipsis: true,
            });
            totalX += colWidth;
        ...
        if (currentY < 750) {
          ...
          doc
            ...
            .font("Helvetica")
            .fontSize(8)
            .text("Prepared By System", 40, currentY + 35, {
              width: 120,
              align: "center",
            })
            .text("Authorized Signatory", 435, currentY + 35, {
              width: 120,
              align: "center",
            });
        }
