...
router.post(
  "/:id/approve",
  authenticateToken,
  requireRole([UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.STAFF]),
...
router.post(
  ...
  authenticateToken,
  requireRole([UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.STAFF]),
  LoansController.verifyCollateral,
);
router.post(
  "/:id/disburse",
  authenticateToken,
...
// Repayment pathways
router.post(
  "/:id/emi/:installmentId/pay",
  authenticateToken,
  LoansController.payEMI,
);
router.post(
  "/:id/part-payment",
  authenticateToken,
  LoansController.makePartPayment,
);
